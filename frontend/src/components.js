          ...
          <div className="lg:col-span-3">
            <div className="space-y-8">
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <div className="grid gap-3">
                          ...
                          <div className="flex items-center space-x-4 p-3 bg-gray-50 rounded-lg">
                            <div className="w-12 h-12 rounded-lg" style={{ backgroundColor: '#A56AE8' }}></div>
                            <div className="flex-1">
                              <div className="flex items-center space-x-4">
                                <code className="font-mono text-sm">brand.primary.300</code>
                                <code className="font-mono text-sm text-gray-600">#A56AE8</code>
                              </div>
                              <p className="text-sm text-gray-600 mt-1">Light backgrounds, tag pills (3.12:1 - Large text only)</p>
                            </div>
                          </div>
                        </div>
              ...
              <div className="text-center py-12">
                <p className="text-gray-500 mb-4">This is a comprehensive brand guidelines document.</p>
                <p className="text-sm text-gray-400">For complete sections and detailed guidelines, continue exploring each section above.</p>
              </div>
            </div>
          </div>
        </div>

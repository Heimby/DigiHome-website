        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-lg font-semibold text-gray-900">Brand Guidelines</h1>
            </div>
          ...
          <div className="lg:col-span-3">
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-br from-purple-600 to-indigo-700 rounded-2xl p-8 text-white">
                <h1 className="text-4xl font-bold mb-4">DigiHome Master Brand Guidelines</h1>
                <p className="text-xl text-purple-100 mb-6">Version 1.0 — Production Ready</p>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                  <div>
                    <div className="font-semibold mb-1">Last Updated</div>
                    <div className="text-purple-100">19 July 2025</div>
                  </div>
                  <div>
                    <div className="font-semibold mb-1">Primary Steward</div>
                    <div className="text-purple-100">Brand Director</div>
                  </div>
                  <div>
                    <div className="font-semibold mb-1">Document Status</div>
                    <div className="text-purple-100">Production Ready</div>
                  </div>
                </div>
              </div>

              {/* Section 0: How to Use */}
              <section id="overview" className="bg-white rounded-xl shadow-sm border">
                <button
                ...
                >
                  <div className="flex items-center">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900">0. How to Use This Document</h2>
                  </div>
                  ...
                  <div className="px-6 pb-6">
                    <div className="prose max-w-none">
                      <p className="text-gray-600 mb-4">
                        <strong>Goal:</strong> Provide every function (design, code, product, marketing, analytics, legal) a <em>single source of truth</em> to build, scale, and protect the DigiHome brand globally.
                      </p>
                      <p className="text-gray-600 mb-4">
                        <strong>Structure:</strong> Strategic Foundation → Verbal Identity → Visual System → Experience (UX/Motion/Accessibility) → Data & AI Ethics → Content & Microcopy → Brand Architecture & Naming → Governance & Operations → Measurement & Optimization → Implementation Roadmap → Appendices.
                      </p>
                      <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                        <p className="text-purple-800 font-medium">
                          When in doubt <strong>defer to Principles (Section 1.3)</strong> then confirm with <strong>Governance Workflow (Section 11)</strong>.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <section id="strategic-core" className="bg-white rounded-xl shadow-sm border">
                <button
                  onClick={() => toggleSection('strategic-core')}
                  className="w-full flex items-center justify-between p-6 text-left hover:bg-gray-50 transition-colors"
                >
                  <div className="flex items-center">
                    <AcademicCapIcon className="w-6 h-6 text-purple-600 mr-3" />
                    <h2 className="text-2xl font-bold text-gray-900">1. Brand Strategic Core</h2>
                  </div>
                  {openSections.has('strategic-core') ? (
                    <ChevronDownIcon className="w-5 h-5 text-gray-500" />
                  ) : (
                    <ChevronRightIcon className="w-5 h-5 text-gray-500" />
                  )}
                ...
                {openSections.has('strategic-core') && (
                  <div className="px-6 pb-6">
                    <div className="space-y-6">
                      {/* Purpose, Vision, Mission */}
                      <div>
                        <h3 className="text-xl font-semibold text-gray-900 mb-4">1.1 Purpose, Vision, Mission</h3>
                        <div className="grid gap-4">
                          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                            <h4 className="font-semibold text-blue-900 mb-2">Purpose</h4>
                            <p className="text-blue-800">Empower property owners to unlock full asset potential via intelligent automation, delivering exceptional guest experiences and sustainable returns.</p>
                          </div>
                          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                            <h4 className="font-semibold text-green-900 mb-2">Vision (5-Year)</h4>
                            <p className="text-green-800">Become the global standard for intelligent property management—synonymous with reliable AI‑driven yield optimization + hospitality excellence across continents.</p>
                          </div>
                          <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                            <h4 className="font-semibold text-purple-900 mb-2">Mission</h4>
                            <p className="text-purple-800">Combine advanced AI decisioning with hospitality stewardship to maximize owner returns, elevate guest satisfaction, and erase operational friction.</p>
                          </div>
                        </div>
                      </div>
                      ...
                      {/* Brand Essence */}
                      <div>
                        <h3 className="text-xl font-semibold text-gray-900 mb-4">1.2 Brand Essence & DNA</h3>
                        <div className="bg-gray-50 rounded-lg p-6">
                          <div className="text-center mb-6">
                            <h4 className="text-2xl font-bold text-purple-600 mb-2">Intelligence • Hospitality • Results</h4>
                            <p className="text-gray-600">Essence Trinity</p>
                          </div>
                          <div className="space-y-4">
                            <div>
                              <h5 className="font-semibold text-gray-900">Positioning Statement</h5>
                              <p className="text-gray-700">For sophisticated property owners seeking maximum returns <em>and</em> operational excellence, DigiHome is the AI‑powered management platform delivering 30–40% higher revenue through automated optimization and hotel‑grade service—validated by 87M+ NOK performance across 450+ properties.</p>
                            </div>
                            <div>
                              <h5 className="font-semibold text-gray-900">Primary Tagline</h5>
                              <p className="text-2xl font-bold text-purple-600">"Intelligence meets hospitality."</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      {/* Brand Principles */}
                      <div>
                        <h3 className="text-xl font-semibold text-gray-900 mb-4">1.3 Brand Principles</h3>
                        <p className="text-gray-600 mb-4">Evaluate every decision against these core principles:</p>
                        <div className="overflow-x-auto">
                          <table className="w-full border-collapse border border-gray-300">
                            <thead>
                              <tr className="bg-gray-50">
                                <th className="border border-gray-300 px-4 py-2 text-left font-semibold">Principle</th>
                                <th className="border border-gray-300 px-4 py-2 text-left font-semibold">Definition</th>
                                <th className="border border-gray-300 px-4 py-2 text-left font-semibold">Acceptable Behavior</th>
                                <th className="border border-gray-300 px-4 py-2 text-left font-semibold">Anti-Pattern</th>
                              </tr>
                            </thead>
                            <tbody>
                              <tr>
                                <td className="border border-gray-300 px-4 py-2 font-medium">Evidence First</td>
                                <td className="border border-gray-300 px-4 py-2">Claims anchored in verifiable data & transparent methodology</td>
                                <td className="border border-gray-300 px-4 py-2">Show metric + timeframe + source</td>
                                <td className="border border-gray-300 px-4 py-2">Vague superlatives ("best", "revolutionary")</td>
                              </tr>
                              <tr>
                                <td className="border border-gray-300 px-4 py-2 font-medium">Human Amplification</td>
                                <td className="border border-gray-300 px-4 py-2">AI augments—not replaces—human judgment & care</td>
                                <td className="border border-gray-300 px-4 py-2">AI does repetitive; humans do complex empathy</td>
                                <td className="border border-gray-300 px-4 py-2">Fully autonomous tone that removes people</td>
                              </tr>
                              <tr>
                                <td className="border border-gray-300 px-4 py-2 font-medium">Clarity Over Hype</td>
                                <td className="border border-gray-300 px-4 py-2">Communicate plainly, translate complexity</td>
                                <td className="border border-gray-300 px-4 py-2">Benefit → How it works → Result</td>
                                <td className="border border-gray-300 px-4 py-2">Buzzword stacking</td>
                              </tr>
                            </tbody>
                          </table>
                        </div>
              ...
              <section id="verbal-identity" className="bg-white rounded-xl shadow-sm border">
                <button
                  onClick={() => toggleSection('verbal-identity')}
                  className="w-full flex items-center justify-between p-6 text-left hover:bg-gray-50 transition-colors"
                >
                  <div className="flex items-center">
                    <CodeBracketIcon className="w-6 h-6 text-purple-600 mr-3" />
                    <h2 className="text-2xl font-bold text-gray-900">2. Verbal Identity</h2>
                  </div>
                  {openSections.has('verbal-identity') ? (
                    <ChevronDownIcon className="w-5 h-5 text-gray-500" />
                  ) : (
                    <ChevronRightIcon className="w-5 h-5 text-gray-500" />
                  )}
                ...
                {openSections.has('verbal-identity') && (
                  <div className="px-6 pb-6">
                    <div className="space-y-6">
                      <div>
                        <h3 className="text-xl font-semibold text-gray-900 mb-4">2.1 Voice Pillars (Weighted)</h3>
                        <div className="grid gap-4">
                          <div className="flex items-center justify-between p-4 bg-blue-50 rounded-lg">
                            <div>
                              <h4 className="font-semibold text-blue-900">Intelligent Confident (35%)</h4>
                              <p className="text-blue-800">"Our AI analyzes 200+ factors every 4 hours."</p>
                            </div>
                          </div>
                          <div className="flex items-center justify-between p-4 bg-green-50 rounded-lg">
                            <div>
                              <h4 className="font-semibold text-green-900">Professional Partnership (30%)</h4>
                              <p className="text-green-800">"We handle complexity; you retain strategic control."</p>
                            </div>
                          </div>
                          <div className="flex items-center justify-between p-4 bg-purple-50 rounded-lg">
                            <div>
                              <h4 className="font-semibold text-purple-900">Results-Oriented Direct (25%)</h4>
                              <p className="text-purple-800">"Average 35% uplift across 450+ properties."</p>
                            </div>
                          </div>
                          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                            <div>
                              <h4 className="font-semibold text-gray-900">Accessible Technical (10%)</h4>
                              <p className="text-gray-700">"Predictive maintenance flags issues weeks early."</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        <h3 className="text-xl font-semibold text-gray-900 mb-4">2.2 Lexicon Guidelines</h3>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                            <h4 className="font-semibold text-green-900 mb-2">✓ Core Terms</h4>
                          ...
                          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                            <h4 className="font-semibold text-yellow-900 mb-2">⚠ Use Carefully</h4>
              ...
              <section id="visual-identity" className="bg-white rounded-xl shadow-sm border">
                <button
                  onClick={() => toggleSection('visual-identity')}
                  className="w-full flex items-center justify-between p-6 text-left hover:bg-gray-50 transition-colors"
                >
                  <div className="flex items-center">
                    <PaintBrushIcon className="w-6 h-6 text-purple-600 mr-3" />
                    <h2 className="text-2xl font-bold text-gray-900">3. Visual Identity System</h2>
                  </div>
                  {openSections.has('visual-identity') ? (
                    <ChevronDownIcon className="w-5 h-5 text-gray-500" />
                  ) : (
                    <ChevronRightIcon className="w-5 h-5 text-gray-500" />
                  )}
                ...
                {openSections.has('visual-identity') && (
                  <div className="px-6 pb-6">
                    <div className="space-y-6">
                      {/* Color Architecture */}
                      <div>
                        <h3 className="text-xl font-semibold text-gray-900 mb-4">3.1 Color Architecture</h3>
                        <p className="text-gray-600 mb-4">
                          <strong>Naming Convention:</strong> <code className="bg-gray-100 px-2 py-1 rounded">brand.[category].[role].[state?].[scale?]</code>
                        </p>
                        
                        <h4 className="text-lg font-semibold text-gray-900 mb-3">Primary Purple Spectrum</h4>
                        <div className="grid gap-3">
                          <div className="flex items-center space-x-4 p-3 bg-gray-50 rounded-lg">
                            <div className="w-12 h-12 rounded-lg" style={{ backgroundColor: '#8B5BE8' }}></div>
                            <div className="flex-1">
                              <div className="flex items-center space-x-4">
                                <code className="font-mono text-sm">brand.primary.500</code>
                                <code className="font-mono text-sm text-gray-600">#8B5BE8</code>
                              </div>
                              <p className="text-sm text-gray-600 mt-1">Primary CTAs, key links (4.51:1 contrast)</p>
                            </div>
                          </div>
                          <div className="flex items-center space-x-4 p-3 bg-gray-50 rounded-lg">
                            <div className="w-12 h-12 rounded-lg" style={{ backgroundColor: '#6B46C1' }}></div>
                            <div className="flex-1">
                              <div className="flex items-center space-x-4">
                                <code className="font-mono text-sm">brand.primary.600</code>
                                <code className="font-mono text-sm text-gray-600">#6B46C1</code>
                              </div>
                              <p className="text-sm text-gray-600 mt-1">Hover/Active states (6.23:1 contrast - AAA)</p>
                            </div>
                          </div>
                        </div>

                        <h4 className="text-lg font-semibold text-gray-900 mb-3 mt-6">Supporting Palette</h4>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                          <div className="text-center p-3 bg-red-50 rounded-lg border">
                            <div className="w-16 h-16 mx-auto rounded-lg mb-2" style={{ backgroundColor: '#E53E3E' }}></div>
                            <code className="text-xs">red.500</code>
                            <p className="text-xs text-gray-600">Alerts, risk</p>
                          </div>
                          <div className="text-center p-3 bg-gray-50 rounded-lg border">
                            <div className="w-16 h-16 mx-auto rounded-lg mb-2" style={{ backgroundColor: '#1A202C' }}></div>
                            <code className="text-xs">navy.700</code>
                            <p className="text-xs text-gray-600">Primary text</p>
                          </div>
                          <div className="text-center p-3 bg-green-50 rounded-lg border">
                            <div className="w-16 h-16 mx-auto rounded-lg mb-2" style={{ backgroundColor: '#38A169' }}></div>
                            <code className="text-xs">green.500</code>
                            <p className="text-xs text-gray-600">Success states</p>
                          </div>
                          <div className="text-center p-3 bg-yellow-50 rounded-lg border">
                            <div className="w-16 h-16 mx-auto rounded-lg mb-2" style={{ backgroundColor: '#D69E2E' }}></div>
                            <code className="text-xs">amber.500</code>
                      ...
                      {/* Typography */}
                      <div>
                        <h3 className="text-xl font-semibold text-gray-900 mb-4">3.2 Typography</h3>
                        <div className="bg-gray-50 rounded-lg p-6">
                          <div className="mb-6">
                            <h4 className="font-semibold text-gray-900 mb-2">Primary Typeface: Inter (Variable)</h4>
                          ...
                          <div className="space-y-4">
                            <div className="flex items-baseline space-x-4">
                              <span className="text-6xl font-thin text-gray-900">Aa</span>
                              <div>
                                <code className="text-sm">display.1</code>
                                <p className="text-sm text-gray-600">64px • 100-300 weight • Hero headlines</p>
                              </div>
                            </div>
                            <div className="flex items-baseline space-x-4">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-gray-600">40px • 600 weight • Page titles</p>
                              </div>
                            </div>
                            <div className="flex items-baseline space-x-4">
                              <span className="text-base text-gray-900">Aa</span>
                              <div>
                                <code className="text-sm">body.base</code>
                                <p className="text-sm text-gray-600">16px • 400 weight • Core text</p>
                              </div>
                            </div>
                          </div>
                        </div>
              ...
              {/* Executive Summary */}
              <section className="bg-gradient-to-br from-purple-600 to-indigo-700 rounded-2xl p-8 text-white">
                <h2 className="text-3xl font-bold mb-4">Executive Summary</h2>
                <p className="text-lg text-purple-100 mb-6">
                  DigiHome's Master Brand Guidelines codify a transformation narrative anchored in verifiable performance, ethical AI, and hospitality-grade service quality. The system operationalizes consistency (tokens, voice pillars, governance), fosters trust (substantiated metrics, transparency), ensures inclusion (WCAG 2.2 AA practices), and accelerates scale (internationalization, experimentation framework).
                </p>
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
                  <h3 className="font-semibold mb-2">Immediate Focus (Next 60 Days)</h3>
                  <p className="text-purple-100 text-sm">
                    Deploy disclaimers + accessible tokens, finalize voice audit & rewrite core pages, launch case study program, implement event taxonomy, baseline brand health survey.
                  </p>
                </div>
                <div className="text-center mt-6">
                  <p className="text-2xl font-bold text-white">
                    <em>"Intelligence meets hospitality delivering measurable results."</em>
                  </p>
                </div>
              </section>
            </div>

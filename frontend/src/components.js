...
export const HomeHumanoidSection = () => {
  ...
  return (
    <section id="home-humanoid" className="bg-gradient-to-br from-gray-50 to-white py-20 lg:py-28">
    ...
    <section className="pt-8 pb-20 lg:pt-12 lg:pb-28 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="space-y-12">
          ...
          <div>
            <h3 className="text-2xl font-semibold text-gray-800 mb-8 text-center">For Property Owners</h3>
            <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
              {/* Visibility, Pricing & Flexibility - Owners */}
              <div className="bg-gray-100 rounded-xl p-8 lg:p-10 relative">
                <h4 className="text-xl font-bold mb-6 text-gray-900">Visibility, Pricing & Flexibility</h4>
              ...
              <div className="bg-gray-100 rounded-xl p-8 lg:p-10 relative">
                <h4 className="text-xl font-bold mb-6 text-gray-900">Seamless Guest Experience</h4>
                <ul className="text-gray-600 leading-relaxed font-light space-y-3 text-sm mb-16">
              ...
              <div className="bg-gray-100 rounded-xl p-8 lg:p-10 relative">
                <h4 className="text-xl font-bold mb-6 text-gray-900">Security, Comfort & Compliance</h4>
                <ul className="text-gray-600 leading-relaxed font-light space-y-3 text-sm mb-16">
          ...
          {/* Row 2: For Tenants */}
          <div>
            <h3 className="text-2xl font-semibold text-gray-800 mb-8 text-center">For Tenants</h3>
            <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
  ...
  return (
    <section id="earnings-calculator" className="relative isolate overflow-hidden bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-gradient-to-r from-indigo-400/10 to-purple-400/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
        <div className="absolute top-1/2 right-1/3 w-64 h-64 bg-gradient-to-r from-blue-400/5 to-purple-400/5 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '4s' }}></div>
